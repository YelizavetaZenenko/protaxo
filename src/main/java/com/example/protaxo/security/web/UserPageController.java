...
public class UserPageController {
    ...
    public String inviteForm(Model model) {
        model.addAttribute("invite", new UserInviteFormData());
        model.addAttribute("roles", Role.values());
        return "users/form";
    }

    @PostMapping
    public String invite(@Valid @ModelAttribute("invite") UserInviteFormData form, BindingResult bindingResult, Model model) {
