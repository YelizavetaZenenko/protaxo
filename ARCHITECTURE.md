...
5. Розділяй логіку по шарах: 
6. Controller -> Service -> Repository. Контролери приймають та повертають DTO, а не самі Entity. Для мапінгу використовуй MapStruct або ручні мапери. 